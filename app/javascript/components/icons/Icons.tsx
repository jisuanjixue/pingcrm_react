...
export const BookIcon = createIcon({
  ...
  viewBox: "0 0 20 20",
  path: <path d="M6 4H5a1 1 0 1 1 0-2h11V1a1 1 0 0 0-1-1H4a2 2 0 0 0-2 2v16c0 1.1.9 2 2 2h12a2 2 0 0 0 2-2V5a1 1 0 0 0-1-1h-7v8l-2-2-2 2V4z" />,
});

export const CheveronDownIcon = createIcon({
  displayName: "CheveronDownIcon",
  viewBox: "0 0 20 20",
  path: <path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" />,
});
export const CheveronRightLogo = createIcon({
  displayName: "CheveronRightLogo",
  viewBox: "0 0 20 20",
  path: <polygon points="12.95 10.707 13.657 10 8 4.343 6.586 5.757 10.828 10 6.586 14.243 8 15.657 12.95 10.707" />,
});

export const LocationIcon = createIcon({
  displayName: "LocationIcon",
  viewBox: "0 0 20 20",
  path: <path d="M10 20S3 10.87 3 7a7 7 0 1 1 14 0c0 3.87-7 13-7 13zm0-11a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" />,
});
...
export const PrinterIcon = createIcon({
  ...
  viewBox: "0 0 20 20",
  path: <path d="M4 16H0V6h20v10h-4v4H4v-4zm2-4v6h8v-6H6zM4 0h12v5H4V0zM2 8v2h2V8H2zm4 0v2h2V8H6z" />,
});

export const ShoppingCart = createIcon({
  displayName: "ShoppingCart",
  viewBox: "0 0 20 20",
  path: <path d="M4 2h16l-3 9H4a1 1 0 1 0 0 2h13v2H4a3 3 0 0 1 0-6h.33L3 5 2 2H0V0h3a1 1 0 0 1 1 1v1zm1 18a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm10 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" />,
});
...
export const TrashIcon = createIcon({
  ...
  viewBox: "0 0 20 20",
  path: <path d="M6 2l2-2h4l2 2h4v2H2V2h4zM3 6h14l-1 14H4L3 6zm5 2v10h1V8H8zm3 0v10h1V8h-1z" />,
});
...
export const SuccessIcon = createIcon({
  ...
  viewBox: "0 0 20 20",
  path: <polygon points="0 11 2 9 7 14 18 3 20 5 7 18" />,
});
