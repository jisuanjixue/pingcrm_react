...
const FlashMessages = () => {
    ...
    return (_jsx(_Fragment, { children: isVisible && (_jsxs(Alert, { status: (() => {
                if (flash.success)
                    return status[1];
                if (flash.alert)
                    return status[2];
            ...
            })(), variant: "left-accent", children: [_jsx(AlertIcon, {}), _jsxs(Box, { children: [_jsx(AlertTitle, { children: (() => {
                                if (flash.success)
                                    flash.success;
                                if (flash.alert)
                                    flash.alert;
              ...
              errors.`;
                            ...
                            })() }), _jsx(AlertDescription, {})] }), _jsx(CloseButton, { alignSelf: "flex-start", position: "relative", right: -1, top: -1, onClick: onClose })] })) }));
};
