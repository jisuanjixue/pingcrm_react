...
/**
 * 【jet-pro】基于antd基础组件，赋值不再需要完整路径，简化树形赋值
 */
export default (function (_ref) {
  var propsOptions = _ref.options,
    propsRequest = _ref.request,
  ...
  var _useSafeState5 = useSafeState(),
    ...
    value = _useSafeState6[0],
    setValue = _useSafeState6[1];
  var _useSafeState7 = useSafeState(),
    _useSafeState8 = _slicedToArray(_useSafeState7, 2),
    setForceRender = _useSafeState8[1];
  var refOptionsFlattened = useRef();
  var isControlled = hasKey(props, 'value');
  var getValue = function getValue() {
    return isControlled ? props.value : value;
  };
            ...
            while (1)
              switch ((_context.prev = _context.next)) {
                ...
                case 2:
                  ...
                  _context.next = 7;
                  return propsRequest === null || propsRequest === void 0 ? void 0 : propsRequest();
                case 7:
   ...
   * @returns
   */
  var flatOptions = useCallback(function (opts, parent) {
    var optionsFlattened = [];
    opts === null || opts === void 0
      ...
      : opts.forEach(function (item) {
          ...
          if (
            ...
            optionsFlattened.push.apply(
              optionsFlattened,
              _toConsumableArray(flatOptions(item.children, item)),
            );
          }
          var itemWithParent = item;
          itemWithParent.parent = parent;
          optionsFlattened.push(itemWithParent);
        });
    return optionsFlattened;
  }, []);
  var getValuesReverse = function getValuesReverse(val) {
    var _refOptionsFlattened$;
    var option =
      (_refOptionsFlattened$ = refOptionsFlattened.current) === null ||
      _refOptionsFlattened$ === void 0
        ? void 0
        : _refOptionsFlattened$.find(function (item) {
    ...
    if (option.parent)
      values = [].concat(
        ...
        _toConsumableArray(getValuesReverse(option.parent.value)),
      );
    return values;
  };
  var getValues = function getValues(val) {
    var values = getValuesReverse(val).reverse();
    if (!values.length) return undefined;
    return values;
  };
  var _onChange = function onChange(values, selectedOptions) {
    var _props$onChange;
    var val =
      values === null || values === void 0
        ? void 0
        : values[(values === null || values === void 0 ? void 0 : values.length) - 1];
      ...
      _extends(
        ...
        _objectSpread(
          ...
          {},
          {
            ...
            onChange: function onChange(items, opts) {
              return _onChange(items, opts);
            },
          },
        ),
      ),
