...
export default (function (props) {
  var _useSafeState = useSafeState(props.value),
    _useSafeState2 = _slicedToArray(_useSafeState, 2),
    value = _useSafeState2[0],
    setValue = _useSafeState2[1];
  var _useDebounceFn = useDebounceFn(
      function (val) {
        var _props$onChange;
        (_props$onChange = props.onChange) === null || _props$onChange === void 0
          ? void 0
          : _props$onChange.call(props, val);
      },
      {
        wait: 500,
      },
    ),
    onChangeDebounce = _useDebounceFn.run;
