var _excluded = ['encType', 'children', 'footerProps', 'footer', 'footerExtra', 'refForm'];
...
export default (function (_ref) {
  ...
  var _useSafeState = useSafeState(),
    ...
    detail = _useSafeState2[0],
    setDetail = _useSafeState2[1];
  var _useSafeState3 = useSafeState(),
    _useSafeState4 = _slicedToArray(_useSafeState3, 2),
    loadingDetail = _useSafeState4[0],
    setLoadingDetail = _useSafeState4[1];
  var _useSafeState5 = useSafeState(),
    _useSafeState6 = _slicedToArray(_useSafeState5, 2),
    loadingSubmit = _useSafeState6[0],
    setLoadingSubmit = _useSafeState6[1];
          ...
          function _callee$(_context) {
            while (1)
              switch ((_context.prev = _context.next)) {
                ...
                case 12:
                  _context.next = 14;
                  return (_props$onSubmit = props.onSubmit) === null || _props$onSubmit === void 0
                    ? void 0
                    : _props$onSubmit.call(props, values);
                case 14:
                  _context.next = 16;
                  return delay(500);
                case 16:
          ...
          while (1)
            switch ((_context2.prev = _context2.next)) {
              ...
              case 3:
                ...
                _context2.next = 6;
                return (_props$initDetail = props.initDetail) === null ||
                  _props$initDetail === void 0
                  ? void 0
                  : _props$initDetail.call(props);
              case 6:
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    footer && _typeof(footer) === 'object' && footer,
    footer &&
