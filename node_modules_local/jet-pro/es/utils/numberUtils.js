...
export var formatCurrency = function formatCurrency(value) {
  var minimumFractionDigits = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2;
  var showStyle = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  if (!isNumber(value)) return '';
  var moneyIntl = new Intl.NumberFormat(
    'zh-Hans-CN',
    _objectSpread(
      _objectSpread(
        {
