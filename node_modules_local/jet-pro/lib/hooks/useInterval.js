...
__export(useInterval_exports, {
  default: () => useInterval_default,
});
module.exports = __toCommonJS(useInterval_exports);
var import_react = require('react');
var import_useMountUnmount = __toESM(require('./useMountUnmount'));
var useInterval_default = (handler, ms = 2e3) => {
  const refInterval = (0, import_react.useRef)();
